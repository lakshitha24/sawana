...
public class AnalyzeActivity extends Activity
        ...
        AdapterView.OnItemClickListener, AnalyzeView.Ready {
...
//        }
    ...
    public void  cArray(final Double value) {
        mylist.add(value);
        if(condtion==true) {
            avgArray(mylist);
            condtion=false;
            Log.i("tag","your array is......,,,,,,,,,,,,,,,,,,,,,,,"+mylist);
        }

    }

    public void avgArray(ArrayList<Double> datas){
    ...
    public void Acount(final double value){
        ...
        new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                mAveg(arr);
                Log.i("tag","your weeeeeeeeeeeeeeeeeew is......,,,,,,,,,,,,,,,,,,,,,,,"+arr);
